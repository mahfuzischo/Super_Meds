...
public class BabyCare extends javax.swing.JFrame {
             ...
             if(evt.getSource()==jButton1)
        {
           ...
           int i=Integer.parseInt(s3); 
            try{
             ...
             String q = "insert into baby_care values('"+s1+"','"+s2+"','"+i+"')";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        /* connection con = new connection();
             DefaultTableModel tblModel =tblModel = (DefaultTableModel)jTable1.getModel();
           
     
             String value = (tblModel.getValueAt(row,0)).toString();
            ...
            String q = "Delete from baby_care where pcode="+value;
            try{
