...
public class BabyProducts extends javax.swing.JFrame {

    /**
     * Creates new form BabyProducts
     */
    public BabyProducts() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BabyProducts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BabyProducts().setVisible(true);
            }
        });
    }
